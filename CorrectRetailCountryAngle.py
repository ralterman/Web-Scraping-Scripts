...
def main():
    ...
    with open('MapInfo_NoCA_Joined.csv', 'r') as input_file:
        ...
        with open('CorrectAngles.csv', 'wb') as output_file:
            objectID_data_writer = csv.DictWriter(output_file, fieldnames=['OBJECTID', 'Angle'],
            ...
            for entry in total:
                if entry not in output:
                    ...
                    # Write row to CSV file consisting of OBJECTID, label, StreetNa_1, county, labelDirec, and Angle for correct data

    print ("")
    print ("-----------------------------")
    print ("")
    print (str(line_count) + " labels matched")
    print ("")
